...
class SattvicEnergy extends StatefulWidget {
  const SattvicEnergy({Key? key}) : super(key: key);

  @override
  State<SattvicEnergy> createState() => _SattvicEnergyState();
}

class _SattvicEnergyState extends State<SattvicEnergy> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                   Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => SattvicFood()),
                  );
                },
                child: commonText(
                    context: context,
                             ...
                             child: Stack(
                               children: [
                                 ...
                                 Positioned(
                                  ...
                                  // bottom: 100,
                                  // left: 50,
                                   child:  sattvicFoodItemsOne(context))
                               ],
                             ),
                           ),
  ...
  Widget sattvicFoodItemsOne(BuildContext context){
    return Padding(
      padding: EdgeInsets.only(
